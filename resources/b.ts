...
export const resources: Resource[] = [
  {
    name: "Belajar Dasar Pemrograman Javascript 1 Jam",
    categories: ["Programming Languages", "JavaScript"],
    keywords: ["javascript", "frontend developer"],
    description:
  ...
  },
  {
    ...
    description:
      "Banyak yang bertanya ke saya bagaimana bisa menguasai banyak bahasa pemrograman. Di vlog kali ini saya coba bahas",
    url: "https://www.youtube.com/watch?v=cihCrD7Nq9M",
  },
  {
    name: "Bagaimana cara mengukur impact kita sebagai software engineer?",
    categories: [
      "Frontend Development",
      "Backend Development",
      "Sharing Experience",
    ],
    keywords: ["software engineer", "impact"],
    description:
